...
function altitude_enqueue_scripts_styles() {
	...
	wp_enqueue_script( 'altitude-backgroundvideo', get_bloginfo( 'stylesheet_directory' ) . '/js/jquery.backgroundvideo.min.js', array( 'jquery' ), '1.3' );
	wp_enqueue_script( 'altitude-backgroundvideo-init', get_bloginfo( 'stylesheet_directory' ) . '/js/jquery.backgroundvideo.init.js', array( 'jquery' ), '1.0' );
...
function sp_custom_footer() {
	...
	<div class="cwright">
		...
		<?php
			$isGuestStream = strpos( $url, 'gueststream.com' );
			$isGuestStreamDev = strpos( $url, 'gueststream.dev' );

		if ( $isGuestStreamDev === FALSE && $isGuestStream === FALSE ) { ?>
			Vacation Rental Marketing by <a href="http://www.gueststream.com" target="_blank"><img style="display: inline-block;vertical-align:top;" src="<?php echo get_stylesheet_directory_uri(); ?>/images/linklogo-new-light.png" border="0"></a>
		<?php } else { ?>
			<a href="http://www.gueststream.com" target="_blank"><img style="display: inline-block;vertical-align:bottom;" src="<?php echo get_stylesheet_directory_uri(); ?>/images/linklogo-new-light.png" border="0"></a>
		<?php } ?>
		</p>
	</div>
	<?php
